  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved server as @server" do
        ...
        post :create, {:server => { "server_use" => "invalid value" }}, valid_session
        assigns(:server).should be_a_new(Server)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested server" do
        ...
        Server.any_instance.should_receive(:update_attributes).with({ "server_use" => "MyString" })
        put :update, {:id => server.to_param, :server => { "server_use" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the server as @server" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Server.any_instance.stub(:save).and_return(false)
        put :update, {:id => server.to_param, :server => { "server_use" => "invalid value" }}, valid_session
        assigns(:server).should eq(server)
      end
